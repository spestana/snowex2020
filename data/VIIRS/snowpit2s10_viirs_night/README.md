...
## 1. Request Parameters  
    ...
    Name: SnowPit2S10_VIIRS_Night  

    Date Completed:** 2021-01-03T17:36:40.005456  

    Id: f09b2274-9bdb-4667-8cc6-6dbf13c0ae18  
    ...
    Details:  
        ...
        Layers:  
            ...
            View_Time (VNP21A1N.001)  
            QC (VNP21A1N.001)  
            Emis_16 (VNP21A1N.001)  
            Emis_14 (VNP21A1N.001)  
            Emis_15 (VNP21A1N.001)  
            View_Angle (VNP21A1N.001)  
            LST_1KM (VNP21A1N.001)  
...
- Comma-separated values file with data extracted for a specific product
  - SnowPit2S10-VIIRS-Night-VNP21A1N-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - SnowPit2S10-VIIRS-Night-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - SnowPit2S10-VIIRS-Night-request.json
- xml file
  - SnowPit2S10-VIIRS-Night-VNP21A1N-001-metadata.xml  
...
- Hulley, G., Hook, S. (2018). VIIRS/NPP Land Surface Temperature and Emissivity Daily L3 Global 1km SIN Grid Night V001. NASA EOSDIS Land Processes DAAC. Accessed 2021-01-03 from https://doi.org/10.5067/VIIRS/VNP21A1N.001. Accessed January 3, 2021.
