...
## 1. Request Parameters  
    ...
    Name: SnowPit2S10_MODIS_Terra  

    Date Completed:** 2021-01-03T17:37:24.946090  

    Id: 3de2128b-6032-4429-813e-303458d2e560  
    ...
    Details:  
        ...
        Layers:  
            ...
            Clear_day_cov (MOD11A1.006)  
            Clear_night_cov (MOD11A1.006)  
            Day_view_angl (MOD11A1.006)  
            Day_view_time (MOD11A1.006)  
            Emis_31 (MOD11A1.006)  
            Emis_32 (MOD11A1.006)  
            LST_Day_1km (MOD11A1.006)  
            LST_Night_1km (MOD11A1.006)  
            Night_view_angl (MOD11A1.006)  
            Night_view_time (MOD11A1.006)  
            QC_Day (MOD11A1.006)  
...
- Comma-separated values file with data extracted for a specific product
  - SnowPit2S10-MODIS-Terra-MOD11A1-006-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - SnowPit2S10-MODIS-Terra-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - SnowPit2S10-MODIS-Terra-request.json
- xml file
  - SnowPit2S10-MODIS-Terra-MOD11A1-006-metadata.xml  
...
- Wan, Z., Hook, S., Hulley, G. (2015). MOD11A1 MODIS/Terra Land Surface Temperature/Emissivity Daily L3 Global 1km SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-01-03 from https://doi.org/10.5067/MODIS/MOD11A1.006. Accessed January 3, 2021.
